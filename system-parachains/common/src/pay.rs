...
/// Pay on the local chain with `fungibles` implementation if the beneficiary and the asset are both local.
    ...
    A::Type: Eq + Clone,
{
    ...
    fn pay(
        ...
        // Always returns MAX; SDK will later handle unique payment IDs.
        Ok(Self::Id::MAX)
    }
